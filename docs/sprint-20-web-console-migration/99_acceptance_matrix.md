...
- PR20.6 console views: provider/model selection, environment keys, tools, skills, diagnostics, logs, and read-only settings views.
...
- `cd web && npm test` (13 files / 19 tests, including layout, provider/diagnostics/logs/environment views, markdown table/code, approval dialog, and persisted tool reconstruction coverage)
