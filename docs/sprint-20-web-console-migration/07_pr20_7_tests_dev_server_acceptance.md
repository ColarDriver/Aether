...
- tools/skills/diagnostics/docs/workspace REST
...
- permission dialog
- approval dialog
- provider/model/settings/docs/workspace/analytics views
...
16. Open Models, Tools, Skills, Diagnostics, Logs, Docs, Workspace, Analytics, Environment, and Settings views.
